...
import { getGameOgCard, getGameOgImage } from '../controllers/og.controller.js';
...
// No auth, these are fetched by link-preview crawlers (WhatsApp, Facebook,
...
router.get('/code/:code/card-image.png', getGameOgImage);
